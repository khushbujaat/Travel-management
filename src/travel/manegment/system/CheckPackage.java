...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {
        ...
        String[] package2 = {"SILVER PACKAGE", "5 Days and 6 Nights", "Toll Free", "Enterance Free Tickets", "Meet and Greet at Airport", "Welcome Driks On Arrivel", "Night Safari", "Cruise with Dinner", "BOOK NOW", "Winter Special","Rs 24000/-", "package2.jpg"};
        String[] package3 = {"BRONZE PACKAGE", "6 Days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & Other", "River Rafting","Hard Drinks Free", "Daily Buffet", "BBQ Dinner", "BOOK NOW", "Winter Special","Rs 32000/-", "package3.jpg"};
